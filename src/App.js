      ...
      >
        <g>
          <g className="currentWeather">
            ...
            ></rect>
            <text x="20" y="21" className="currentDateText">
              SUNDAY @ 9:37 AM
            </text>
            <rect
              x="0"
            ...
            ></rect>
            <text className="currentTempText" x="60" y="55">
              15&#8451;;
            </text>
            <rect
              x="0"
            ...
            <image
              ...
              height="100"
            ></image>
            <text className="currentWindText" x="66" y="125">
              14
            </text>
            <image
              transform="rotate(210.39999999999998, 135.03127511445913, 178.4379192527066)"
              width="20"
              height="20"
              x="185"
              y="215"
            ...
            <rect
              ...
              width="158"
              height="35"
              className="currentWater"
            ></rect>
            <text className="currentWaterText" x="40" y="189">
              UV: 7 High
            </text>
          </g>
          ...
          <g>
            <rect
              ...
              className="titleLine"
            ></rect>
            <text x="420" y="20" className="titleLineText">
              5-Day Forecast
            </text>
          </g>
          <g>
            ...
            <text x="215" y="52" className="currentDateText">
              Monday
            </text>
          </g>
          <g>
            ...
            <text x="370" y="52" className="currentDateText">
              Tuesday
            </text>
          </g>
          <g>
            ...
            <text x="520" y="52" className="currentDateText">
              Wednesday
            </text>
          </g>
          <g>
            ...
            <text x="690" y="52" className="currentDateText">
              Thursday
            </text>
          </g>
          ...
          <symbol id="heatLine">
            <svg viewBox="-20 0 100 50" preserveAspectRatio="none">
              <g>
                <path
                  d="M0,30 v20 h100 v-20 Q70,10 50,30 T0,30"
                  className="heatLine"
                />
              </g>
            </svg>
